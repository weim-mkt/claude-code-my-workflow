...
Return the report as your final response; the calling skill saves it to `quality_reports/[script_name]_r_review.md` (your `tools:` grant is read-only by design):
