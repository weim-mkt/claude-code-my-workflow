...
Return the report as your final response; the calling skill saves it to `quality_reports/[package_name]_package_review.md` (your `tools:` grant is read-only by design):
